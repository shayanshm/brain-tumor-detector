...
> **یادداشت روش‌شناسی (Phase 0/2):** سند اصلی پروژه در چک‌لیست Phase 2 «Verify five classes» را
> خواسته است. دیتاست واقعی این پروژه (تاییدشده از `data.yaml`) دقیقاً **۳ کلاس** دارد
> (glioma/meningioma/pituitary)، نه ۵. این چک‌لیست ظاهراً برای یک دیتاست/مقاله‌ی دیگر (که سند به آن
> اشاره کلی داشت: «link 1 or link 2 or link 3») نوشته شده و مستقیماً روی این دیتاست خاص که دانشجو
> انتخاب کرده صدق نمی‌کند. تصمیم گرفته شد: تعداد کلاس واقعی دیتاست (۳) ملاک عمل باشد، نه عدد ثابت
> در چک‌لیست عمومی سند.
