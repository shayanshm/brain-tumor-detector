...
این الگو **سه‌بار مستقل** تایید شده: (۱) ماتریس درهم‌ریختگی YOLO در Phase 4، (۲) ارزیابی رسمی
test-split YOLO (mAP per-class)، و (۳) همین پایپ‌لاین سفارشی برای هر دو مدل. پشتوانه‌ی علمی کامل
در `reports/literature_review.md` (رفرنس‌های ۱۶-۲۱) — گلیوما به‌خاطر مرزهای نفوذی/غیرمشخص در MRI
ذاتاً سخت‌تر از meningioma/pituitary (که خوش‌مرزند) تشخیص داده می‌شود، صرف‌نظر از حجم بیشتر داده‌ی
آموزشی‌اش.
