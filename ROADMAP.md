...
- [x] 2.1 دانلود/دسترسی به دیتاست روی Kaggle — تایید شد توسط کاربر
- [x] 2.2 وریفای ساختار خام: `split/images` + `split/labels` (تایید شده با اجرای واقعی کاربر روی Kaggle)
      نتیجه: train=2144, valid=612, test=308 → مجموع 3064 تصویر (دقیقاً برابر دیتاست کلاسیک Cheng et al.)
- [x] 2.3 ~~تعیین کلاس‌ها~~ ✅ glioma, meningioma, pituitary
- [ ] 2.4 تحلیل توزیع کلاس‌ها — اسکریپت آماده (`analyze_annotations.py`)، **در انتظار اجرای شما روی داده واقعی**
- [ ] 2.5 ویژوالایز نمونه‌ها — اسکریپت آماده و با تصاویر واقعی تست شد (`visualize_samples.py`)، **در انتظار اجرای شما**
- [ ] 2.6 کیفیت annotation — همراه با 2.4 اجرا می‌شود (چک‌های bbox نامعتبر/سرریز از مرز)
- [ ] 2.7 تبدیل annotation به COCO JSON — بعد از دیدن نتایج 2.4/2.6 نوشته می‌شود
